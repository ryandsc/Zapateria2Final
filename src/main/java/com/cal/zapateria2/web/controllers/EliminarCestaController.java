...
@Controller
public class EliminarCestaController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/vaciarcesta.htm")
	public ModelAndView manejadorCesta() {
		CestaController metodos=new CestaController();
		metodos.ejecutarSQL("DELETE FROM public.cesta;");
